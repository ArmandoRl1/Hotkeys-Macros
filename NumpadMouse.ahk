...
; --- GENERAL CONFIGURATION ----------------------------------------------------
  ...
  MaxSpeed      := 1      ; Pixels to move at the fastest inertia
...
MouseMoveHandler:
  ...
  Loop {
    ...
    Else {    ; Mouse moves
      ...
      X := Speed *0.1* ( GetKeyState( RightKey, "P" ) ? 1 : GetKeyState( LeftKey, "P" ) ? -1 : 0 )
      Y := Speed *0.1* ( GetKeyState( DownKey , "P" ) ? 1 : GetKeyState( UpKey, "P" )   ? -1 : 0 )
